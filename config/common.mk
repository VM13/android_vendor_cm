...
# Omni Switch
PRODUCT_COPY_FILES += \
    vendor/cm/prebuilt/common/OmniSwitch/org.omnirom.omniswitch.apk:system/priv-app/OmniSwitch/org.omnirom.omniswitch.apk

# OTA Updater
PRODUCT_COPY_FILES += \
    vendor/cm/prebuilt/common/OTA-Updater/OTA-Updater-2.0.5.apk:system/app/OTA-Updater/OTA-Updater-2.0.5.apk

# OTA Prop
PRODUCT_COPY_FILES += \
    vendor/cm/prebuilt/common/system/rom.ota.prop:system/rom.ota.prop

# OTA Updater feature file
PRODUCT_COPY_FILES += \
    vendor/cm/prebuilt/common/system/etc/permissions/com.otaudater.feature.xml:system/etc/permissions/com.otaudater.feature.xml
